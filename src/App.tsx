        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-brand-gold hover:text-brand-ink transition-all duration-300 backdrop-blur-sm"
...
const About = () => {
  return (
    <section id="about" className="py-24 px-6 md:px-16 bg-white dark:bg-dark-bg transition-colors duration-500 overflow-hidden">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <ScrollReveal>
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-brand-gold rounded-2xl flex flex-col items-center justify-center text-brand-ink p-6 text-center shadow-xl dark:bg-brand-gold/90">
        ...
        <ScrollReveal delay={0.2} direction="left">
          ...
          <h2 className="text-5xl md:text-6xl font-serif mb-8 leading-tight dark:text-brand-cream text-brand-ink">
            Authentic Flavors <br />
            <span className="italic text-brand-olive dark:text-brand-gold/80">Since Generations</span>
          </h2>
          <div className="space-y-6 text-brand-ink/70 dark:text-brand-cream/70 leading-relaxed text-lg">
            <p>
...
const Features = () => {
  ...
  return (
    <section className="py-24 bg-brand-cream dark:bg-[#151515] transition-colors duration-500 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        <ScrollReveal direction="up">
          <div className="text-center mb-16">
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-4 block">Our Services</span>
            <h2 className="text-4xl md:text-5xl font-serif mb-6 dark:text-brand-cream text-brand-ink">How We Serve You</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <ScrollReveal key={f.title} delay={i * 0.1} direction="up">
              <div className="bg-white dark:bg-dark-surface p-10 rounded-3xl text-center shadow-sm hover:shadow-md transition-all border border-brand-ink/5 dark:border-white/5">
                <div className="w-16 h-16 bg-brand-gold/10 rounded-full flex items-center justify-center text-brand-gold mx-auto mb-6">
                  {f.icon}
                </div>
                <h3 className="text-2xl font-serif mb-4 dark:text-brand-cream text-brand-ink">{f.title}</h3>
                <p className="text-brand-ink/60 dark:text-brand-cream/60 text-sm leading-relaxed">{f.desc}</p>
              </div>
            </ScrollReveal>
          ))}
        </div>
...
const Menu = () => {
  ...
  return (
    <section id="menu" className="py-24 bg-brand-cream dark:bg-[#151515] transition-colors duration-500 px-6 md:px-16">
      <div className="max-w-5xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-4 block">Our Specialties</span>
            <h2 className="text-5xl md:text-6xl font-serif mb-6 dark:text-brand-cream text-brand-ink">The Menu</h2>
            <div className="w-24 h-[2px] bg-brand-gold mx-auto" />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.1} direction="up">
          <div className="flex flex-wrap justify-center gap-4 md:gap-12 mb-16 border-b border-brand-ink/10 dark:border-white/10 pb-4">
            {MENU.map((category, idx) => (
              <button
                key={category.title}
                onClick={() => setActiveTab(idx)}
                className={`pb-4 text-xs uppercase tracking-[0.2em] font-bold transition-all relative ${activeTab === idx ? 'text-brand-ink dark:text-brand-gold' : 'text-brand-ink/40 dark:text-brand-cream/40 hover:text-brand-ink/60 dark:hover:text-brand-cream/60'}`}
              >
                {category.title}
                {activeTab === idx && (
                  <motion.div
            ...
            >
              {MENU[activeTab].items.map((item, idx) => (
                <ScrollReveal key={item.name} delay={idx * 0.1}>
                  <div className="bg-white dark:bg-dark-surface p-8 rounded-2xl shadow-sm hover:shadow-md transition-all border border-brand-ink/5 dark:border-white/5 group">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-2xl font-serif text-brand-ink dark:text-brand-cream group-hover:text-brand-gold transition-colors">
                            {item.name}
                          </h3>
                          {item.tag && (
                        ...
                        <p className="text-brand-ink/60 dark:text-brand-cream/60 italic font-light">
                          {item.description}
                        </p>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="h-[1px] w-12 bg-brand-gold/30 hidden md:block" />
                        <span className="text-xl font-bold text-brand-ink dark:text-brand-cream whitespace-nowrap">{item.price}</span>
                      </div>
                    </div>
                  </div>
                </ScrollReveal>
...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="py-24 bg-white dark:bg-dark-bg transition-colors duration-500 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        <ScrollReveal direction="up">
          <div className="flex flex-col items-start mb-16 gap-8">
            <div>
              ...
              <h2 className="text-5xl md:text-6xl font-serif text-left dark:text-brand-cream text-brand-ink">Atmosphere</h2>
            </div>
            <p className="max-w-md text-brand-ink/60 dark:text-brand-cream/60 italic text-left">
...
const Reservation = () => {
  ...
  return (
    <section id="reservation" className="py-24 bg-white dark:bg-dark-surface transition-colors duration-500 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal>
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-4 block">Join Us</span>
            <h2 className="text-5xl md:text-6xl font-serif mb-8 dark:text-brand-cream text-brand-ink">Book Your Table</h2>
            <p className="text-brand-ink/60 dark:text-brand-cream/60 text-lg mb-10 leading-relaxed">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 text-brand-ink dark:text-brand-cream">
                <div className="w-10 h-10 rounded-full bg-brand-cream dark:bg-brand-ink flex items-center justify-center"><Phone size={18} /></div>
                <span className="font-bold">05 35 68 30 89</span>
              </div>
              <div className="flex items-center space-x-4 text-brand-ink dark:text-brand-cream">
                <div className="w-10 h-10 rounded-full bg-brand-cream dark:bg-brand-ink flex items-center justify-center"><Clock size={18} /></div>
          ...
          <ScrollReveal delay={0.2}>
            <div className="bg-brand-cream dark:bg-[#151515] p-10 rounded-3xl shadow-sm">
              {status === 'success' ? (
                <motion.div
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 dark:text-brand-cream/40 ml-1">Name</label>
                      <input required name="name" type="text" className="w-full bg-white dark:bg-white/10 dark:border dark:border-white/10 dark:text-brand-cream border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-brand-gold outline-none transition-all" placeholder="Your Name" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 dark:text-brand-cream/40 ml-1">Phone</label>
                      <input required name="phone" type="tel" className="w-full bg-white dark:bg-white/10 dark:border dark:border-white/10 dark:text-brand-cream border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-brand-gold outline-none transition-all" placeholder="06..." />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 dark:text-brand-cream/40 ml-1">Email</label>
                    <input required name="email" type="email" className="w-full bg-white dark:bg-white/10 dark:border dark:border-white/10 dark:text-brand-cream border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-brand-gold outline-none transition-all" placeholder="email@example.com" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 dark:text-brand-cream/40 ml-1">Date</label>
                      <input required name="date" type="date" className="w-full bg-white dark:bg-white/10 dark:border dark:border-white/10 dark:text-brand-cream border-none rounded-xl px-3 py-3 text-sm focus:ring-2 focus:ring-brand-gold outline-none transition-all" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 dark:text-brand-cream/40 ml-1">Time</label>
                      <input required name="time" type="time" className="w-full bg-white dark:bg-white/10 dark:border dark:border-white/10 dark:text-brand-cream border-none rounded-xl px-3 py-3 text-sm focus:ring-2 focus:ring-brand-gold outline-none transition-all" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 dark:text-brand-cream/40 ml-1">Guests</label>
                    <select name="guests" className="w-full bg-white dark:bg-white/10 dark:border dark:border-white/10 dark:text-brand-cream border-none rounded-xl px-3 py-3 text-sm focus:ring-2 focus:ring-brand-gold outline-none transition-all">
...
const Contact = () => {
  return (
    <section id="contact" className="py-24 bg-brand-cream dark:bg-[#151515] transition-colors duration-500 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-4 block">Visit Us</span>
            <h2 className="text-5xl md:text-6xl font-serif mb-6 dark:text-brand-cream text-brand-ink">Location</h2>
          </div>
        </ScrollReveal>

        <ScrollReveal delay={0.2} direction="up">
          <div className="bg-white dark:bg-dark-surface rounded-[40px] overflow-hidden shadow-xl border border-brand-ink/5 dark:border-white/5">
            <div className="grid md:grid-cols-3">
              <div className="p-12 md:col-span-1 space-y-12">
                <div>
                  ...
                  <p className="text-xl font-serif dark:text-brand-cream text-brand-ink">Boulevard Mohamed V, <br />Sefrou 31000, Morocco</p>
                </div>
                <div>
                  <h4 className="text-xs uppercase tracking-widest font-bold text-brand-gold mb-4">Contact</h4>
                  <p className="text-xl font-serif dark:text-brand-cream text-brand-ink">05 35 68 30 89</p>
                  <p className="text-brand-ink/50 dark:text-brand-cream/50 text-sm mt-1">seqqaya.com</p>
                </div>
              </div>
